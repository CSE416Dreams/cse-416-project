...
public class VotingMeasureService {
	...
	public VotingMeasureService() {//double efficiencyGap, int[] estimatedVotingResults, double meanMedianDifference,
		...
		votemeasures.put("georgia-plan2-vote",  new VotingMeasure("georgia-plan2-vote", 0.5, new int[] {8,7,6,2}, 0.5, 0.4, 3));
		votemeasures.put("florida-plan1-vote",  new VotingMeasure("florida-plan1-vote", 0.5, new int[] {8,7,6,2}, 0.5, 0.4, 3));
		votemeasures.put("florida-plan2-vote",  new VotingMeasure("florida-plan2-vote", 0.5, new int[] {8,7,6,2}, 0.5, 0.4, 3));
		votemeasures.put("florida-plan2-vote",  new VotingMeasure("florida-plan3-vote", 0.5, new int[] {8,7,6,2}, 0.5, 0.4, 3));
	}
